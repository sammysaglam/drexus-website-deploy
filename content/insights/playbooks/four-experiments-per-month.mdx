...
<DownloadCTA
  title="4-Week Experiment Calendar"
  description="Ready-to-use template for planning your first month of experiments"
  fileUrl="/tools/experiment-planner"
  fileSize="Interactive planner"
/>

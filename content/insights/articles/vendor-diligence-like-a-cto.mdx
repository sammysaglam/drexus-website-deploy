...
| ------------- | ------ | ----------------------------------------------- | ----------------------------------- |
| Technical Fit | 25%    | Solves core problem, API quality, documentation | "Roadmap" features, poor docs       |
| Reliability   | 20%    | Uptime history, architecture, redundancy        | &lt;99.5% historical, single region |
| Support       | 20%    | Response times, expertise, escalation           | Offshore only, no escalation path   |
...
| Scale         | 10%    | Growth alignment, performance                   | No enterprise customers             |
...
<DownloadCTA
  title="CTO's Vendor Scorecard"
  description="The complete evaluation framework we use for all vendor decisions"
  fileUrl="/tools/vendor-diligence-scorecard"
  fileSize="Scoring spreadsheet"
/>

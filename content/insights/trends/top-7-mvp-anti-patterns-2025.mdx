...
## The 7 Anti-Patterns Killing MVPs in 2025

<Figure
  src="/images/charts/mvp-anti-patterns-frequency.svg"
  alt="Bar chart showing frequency of MVP anti-patterns: Platform Thinking (68%), Feature FOMO (61%), Perfection Paralysis (54%), Infrastructure First (47%), Committee Design (42%), Metrics Theater (38%), Silent Launch (31%)"
  caption="Frequency of anti-patterns in failed MVPs (n=150). Data collected Q1 2025."
/>
...
<DownloadCTA
  title="MVP Anti-Pattern Checklist"
  description="Audit your MVP plan against all 7 anti-patterns"
  fileUrl="/tools/mvp-scope-builder"
  fileSize="Interactive tool"
/>

...
export const sendEmailNotification = async (data: EmailData) => {
  try {
    console.warn("Sending email notification to:", "giordano.carreiro@digalyze.com");
          ...
          <div style="background: #f8fafc; border-radius: 8px; margin-bottom: 20px; text-align: left;">
            <div style="padding: 20px 20px 20px 0;">
              ...
              <p style="color: #374151; line-height: 1.6; margin-bottom: 15px; text-align: left; margin-left: 0; padding-left: 0;">
                Thank you for joining our community of ambitious leaders who understand that technology isn't just about tools—it's about strategic advantage.
              </p>
...
export const sendEventSubscriptionNotification = async (data: EventSubscriptionData) => {
  try {
    console.warn("Sending event subscription notification to:", "giordano.carreiro@digalyze.com");
...
export const sendInsightsSubscriptionNotification = async (data: InsightsSubscriptionData) => {
  try {
    console.warn(
      "Sending insights subscription notification to:",
      "giordano.carreiro@digalyze.com"
    );
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: #eff6ff; border-radius: 8px; margin-bottom: 20px; text-align: left;">
            <div style="padding: 20px;">
              <h3 style="color: #1e3a8a; font-size: 18px; margin-bottom: 10px;">📅 Delivery Schedule</h3>
              <p style="color: #374151; line-height: 1.6; margin: 0;">
                Every Friday, you'll receive our curated insights directly in your inbox. No fluff, no sales pitches—just proven strategies that work.
              </p>
            </div>
          </div>

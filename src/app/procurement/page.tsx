    ...
    <>
      ...
      <section className="py-12">
        <div className="container mx-auto px-6 max-w-screen-xl">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8" id="sticky-container">
            {/* Main Content */}
            <div className="lg:col-span-2 space-y-12" id="main-content-section">
              {/* Security Checklist */}
              <div>
                ...
                <Card className="!bg-white !shadow-lg border border-gray-200">
                  <CardBody className="p-6">
                    ...
                    <Button
                      onPress={openModal}
                      size="lg"
                      className="w-full px-8 py-4 bg-navy-600 text-white font-semibold rounded hover:bg-navy-700 transition-colors rounded-xl"
                    >

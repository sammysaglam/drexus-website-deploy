                      ...
                      <CardBody className="p-8">
                        ...
                        <div className="space-y-6">
                          ...
                          <div>
                            ...
                            <p className="text-gray-700">$10k/month media spend recommended</p>
                          </div>
                          <div>
                            <h4 className="font-semibold text-gray-900 mb-2">Fee Structure</h4>
                            <p className="text-2xl font-bold text-blue-600">15-20% of spend</p>
                            <p className="text-sm text-gray-600 mt-1">
                              Or flat fee starting at $5k/month
                            </p>
                          </div>
                        </div>
                      </CardBody>

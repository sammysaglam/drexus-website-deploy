        ...
        <div className="mx-auto px-4 sm:px-6 max-w-4xl">
          ...
          >
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-serif font-bold mb-6 leading-tight">
              "We Hired 'Affordable,' It Cost €27k."
            </h1>
            <p className="text-lg sm:text-xl text-gray-200 mb-8 leading-relaxed">
              The hidden math behind cheap devs. Use our fixed-price estimator to see what reliable
              actually costs, and saves.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <Button
                as="a"
                href="/docs/Drexus Scope Guide.pdf"
                download="Drexus Scope Guide.pdf"
                size="lg"
                variant="bordered"
                className="border-white text-white hover:bg-white hover:text-navy-900 font-semibold px-8 py-3 w-full sm:w-auto"
              >
                Get the Free Guide: App Scope 1-Pager →
              </Button>
            </div>
          </motion.div>
        </div>

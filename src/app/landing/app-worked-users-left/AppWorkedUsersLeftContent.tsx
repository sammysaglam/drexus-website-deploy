        ...
        <div className="mx-auto px-4 sm:px-6 max-w-4xl">
          ...
          >
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-serif font-bold mb-6 leading-tight">
              The App Worked. The Users Left.
            </h1>
            <p className="text-lg sm:text-xl text-gray-200 mb-8 leading-relaxed">
              Launch isn't the goal—traction is. Use our Project Feedback Loop to validate fast and
              impress your next investor.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                Open the Project Feedback Loop Tool →
              </Button>
              <Button
                onPress={() => handleDownload("Drexus Retention Checklist.pdf")}
                size="lg"
                variant="bordered"

        ...
        <div className="mx-auto px-4 sm:px-6 max-w-4xl">
          ...
          >
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-serif font-bold mb-6 leading-tight">
              My Developer Vanished Mid-Sprint.
            </h1>
            <p className="text-lg sm:text-xl text-gray-200 mb-8 leading-relaxed">
              We've all been there. Here's the exact 2-week project plan founders use to recover
              fast — scope, code, cadence. Free template included.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                as="a"
                href="/docs/Drexus Recovery Checklist.pdf"
                download="Drexus Recovery Checklist.pdf"
                size="lg"
                className="bg-navy-900 hover:bg-navy-800 text-white font-semibold px-8 py-3 w-full sm:w-auto"
              >
                Get the Free Recovery Plan →
              </Button>
              <Button
              ...
              >
                Download the 2-Week Project Playbook →
              </Button>
            </div>
          </motion.div>
        </div>

...
import { Button, Card, CardBody, Input, Slider, useDisclosure } from "@heroui/react";

import { EmailCaptureModal } from "@/components/tools/EmailCaptureModal";
import { PageHeader } from "@/components/ui/PageHeader";
import { downloadPDF, getDateString } from "@/lib/download-utils";
...
export default function VendorDiligenceScorecardPage() {
  ...
  const handleDownload = () => {
    ...
    const filename = `vendor-scorecard-${vendorName.toLowerCase().replace(/\s+/g, "-")}-${getDateString()}`;
    ...
    return (
      <>
        <PageHeader
          ...
          subtitle="Review your vendor evaluation and download the report"

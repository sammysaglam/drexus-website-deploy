        ...
        <section className="py-20">
          <div className="container mx-auto px-6 max-w-screen-xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
              <TestimonialCard
                quote="Drexus delivered our marketplace MVP in 5 weeks. We onboarded our first 100 vendors within days of launch and closed our Series A three months later."
                author={{
                  name: "Sarah Chen",
                  title: "CEO, MarketFlow (YC S22)",
                }}
              />
              <TestimonialCard
                quote="We were burning $200k/month trying to hire. Drexus got us to market 4x faster than our original timeline. Best decision we made."
                author={{

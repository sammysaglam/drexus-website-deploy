...
export default function Pilot2WeekPage() {
  ...
  const pilotTerms = [
    ...
    {
      term: "Fixed Price",
      description: "$400 - $2,500 depending on complexity",
    },
    {
      term: "Fixed Timeline",
            ...
            <div className="relative max-w-4xl mx-auto">
                ...
                <Card>
                  <CardBody className="p-6">
                    <div className="flex flex-col md:flex-row md:items-start">
                      <div className="bg-orange-600 text-white px-4 py-2 rounded-full font-bold mb-4 md:mb-0 md:mr-4 whitespace-nowrap self-start">
                        Day -2 to 0
                      </div>
              ...
              >
                <Card>
                  <CardBody className="p-6">
                    <div className="flex flex-col md:flex-row md:items-start">
                      <div className="bg-blue-600 text-white px-4 py-2 rounded-full font-bold mb-4 md:mb-0 md:mr-4 whitespace-nowrap self-start">
                        Week 1
                      </div>
                      <div className="flex-1">
              ...
              >
                <Card>
                  <CardBody className="p-6">
                    <div className="flex flex-col md:flex-row md:items-start">
                      <div className="bg-green-600 text-white px-4 py-2 rounded-full font-bold mb-4 md:mb-0 md:mr-4 whitespace-nowrap self-start">
                        Week 2
                      </div>
                      <div className="flex-1">
        ...
        <section className="py-20">
          <div className="container mx-auto px-6 max-w-screen-xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
              <TestimonialCard quote="The 2-week pilot eliminated all our concerns. We saw their code quality, communication style, and problem-solving approach firsthand. Now they're our go-to technical partner." />
              <TestimonialCard quote="We were skeptical about outsourcing critical features. The pilot proved they could integrate seamlessly with our team. Six months later, they've delivered 10x the pilot's value." />
            </div>

        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-6 max-w-screen-xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
              <TestimonialCard
                quote="Drexus increased our trial-to-paid conversion from 11% to 29% in just 4 weeks. The ROI was evident within the first month."
                author={{
                  name: "Michael Torres",
                  title: "VP Operations, CloudSync",
                }}
              />
              <TestimonialCard
                quote="We were skeptical about quick wins, but they reduced our checkout abandonment by 40% in week 2. Game-changing expertise."
                author={{
                  name: "Jennifer Wu",

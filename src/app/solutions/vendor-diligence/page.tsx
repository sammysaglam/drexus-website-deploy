        ...
        <section className="py-20">
          <div className="container mx-auto px-6 max-w-screen-xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
              <TestimonialCard
                quote="Drexus saved us from a $2M mistake. The vendor looked perfect on paper, but their assessment uncovered critical security flaws and a history of abandoned projects."
                author={{
                  name: "Patricia Morgan",
                  title: "VP Digital Transformation, Fortune 500 Retailer",
                }}
              />
              <TestimonialCard
                quote="As a non-technical executive, I finally had the confidence to push back on vendor claims. Their report gave me the ammunition to negotiate 40% off the initial quote."
                author={{
                  name: "Robert Kim",
                  title: "COO, Global Logistics Company",
                }}
              />
            </div>

        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-6 max-w-screen-xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
              <TestimonialCard
                quote="We were stuck on a database migration for 8 months. Drexus completed it in 3 weeks with zero downtime. Our team learned techniques we still use today."
                author={{
                  name: "David Park",
                  title: "Engineering Director, DataPro",
                }}
              />
              <TestimonialCard
                quote="They unblocked our microservices transition that was stalled for a year. Clean architecture, great docs, and our velocity increased 3x post-engagement."
                author={{
                  name: "Rachel Green",
                  title: "VP Engineering, CloudFirst",
                }}
              />
            </div>

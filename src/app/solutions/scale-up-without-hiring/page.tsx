        ...
        <section className="py-20">
          <div className="container mx-auto px-6 max-w-screen-xl">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              >
                <div className="w-16 h-16 bg-blue-600 text-white rounded-full flex items-center justify-center font-bold text-xl mr-6 flex-shrink-0">
                  1
                </div>
              ...
              >
                <div className="w-16 h-16 bg-green-600 text-white rounded-full flex items-center justify-center font-bold text-xl mr-6 flex-shrink-0">
                  4
                </div>
                <div className="flex-1">
        ...
        <section className="py-20">
          <div className="container mx-auto px-6 max-w-screen-xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
              <TestimonialCard
                quote="We went from 3 to 18 engineers in 2 weeks for a critical launch. No recruiting, no onboarding—just instant productivity. Saved us 6 months and $500k."
                author={{
                  name: "Tom Harrison",
                  title: "CTO, MarketplaceOS",
                }}
              />
              <TestimonialCard
                quote="Drexus gives us the flexibility to scale our team with market demands. During peak season, we 5x our capacity. In quiet periods, we scale back. Perfect elasticity."
                author={{
                  name: "Lisa Park",
                  title: "VP Engineering, E-commerce Platform",
                }}
              />
            </div>

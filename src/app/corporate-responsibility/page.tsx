...
export default function CorporateResponsibilityPage() {
  ...
  return (
    <>
      ...
      <section className="py-16 bg-navy-900 text-white">
        <div className="container mx-auto px-6 max-w-screen-xl">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Link
              href="/corporate-responsibility/2023-report"
      ...
      <section className="py-16">
        <div className="container mx-auto px-6 max-w-screen-xl">
          <h2 className="text-3xl font-bold text-navy-900 mb-12 text-center">Our Partners</h2>
          <div className="max-w-3xl mx-auto">
            <p className="text-lg text-gray-700 text-center mb-8">
              We work with organizations that share our commitment to responsible technology and
              social impact.
            </p>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {["UN Global Compact", "B Corp", "1% for the Planet", "Tech for Good"].map(
                (partner, index) => (
                  <div
                    key={index}
                    className="bg-gray-100 rounded-lg p-6 flex items-center justify-center"
                  >

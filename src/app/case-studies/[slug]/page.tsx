...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: `${caseStudy.title} - ${caseStudy.client} | Case Studies`,
...
export default async function CaseStudyDetailPage({ params }: PageProps) {
  ...
  return (
    <>
      ...
      <PageHeader title={caseStudy.title} subtitle={caseStudy.client} breadcrumbs={breadcrumbs} />
                  ...
                  {caseStudy.results.metrics.map((metric, index) => (
                    <div key={index} className="text-center">
                      <StatBlock
                        ...
                        trend={
                          metric.change
                            ? { value: parseFloat(metric.change), isPositive: true }
                            : undefined
                        }
                      />
                    </div>

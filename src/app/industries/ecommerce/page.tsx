          ...
          <div className="container mx-auto px-6 max-w-screen-xl">
            <div className="max-w-4xl mx-auto">
              <TestimonialCard
                testimonial={{
                  quote:
                    "Drexus didn't just build us an online store—they created a commerce engine that scales. Our conversion rate tripled, and we handle 10x the traffic without breaking a sweat.",
                  author: "Jessica Park",
                  title: "CEO",

        ...
        <section className="py-20">
          <div className="container mx-auto px-6 max-w-screen-xl">
            <div className="max-w-4xl mx-auto">
              <TestimonialCard
                quote="Drexus navigated our complex regulatory requirements while delivering a platform that processes millions in transactions daily. They're true FinTech experts."
                author={{
                  name: "Sarah Thompson",
                  title: "CEO",

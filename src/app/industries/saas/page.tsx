        ...
        <section className="py-20">
          <div className="container mx-auto px-6 max-w-screen-xl">
            <div className="max-w-4xl mx-auto">
              <TestimonialCard
                quote="Drexus understands SaaS at a deep level. They didn't just build features—they helped us architect for scale, optimize our unit economics, and create a platform that developers love to integrate with."
                author={{
                  name: "Michael Chen",
                  title: "CTO",

        ...
        <section className="py-20">
          <div className="container mx-auto px-6 max-w-screen-xl">
            <div className="max-w-4xl mx-auto">
              <TestimonialCard
                quote="Drexus solved our chicken-and-egg problem brilliantly. They built features that attracted sellers first, then created tools that brought buyers. Now we're the leader in our category."
                author={{
                  name: "Tom Anderson",
                  title: "Founder & CEO",

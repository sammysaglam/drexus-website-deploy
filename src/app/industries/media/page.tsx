        ...
        <section className="py-20">
          <div className="container mx-auto px-6 max-w-screen-xl">
            <div className="max-w-4xl mx-auto">
              <TestimonialCard
                quote="Drexus built us a streaming platform that handles our biggest live events without a hiccup. 5 million concurrent viewers? No problem. That reliability is priceless."
                author={{
                  name: "Mark Harrison",
                  title: "CTO",
